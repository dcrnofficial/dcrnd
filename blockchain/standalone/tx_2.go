...
// with a zero hash.
func IsCoinBaseTxV2(tx *wire.MsgTx, isTreasuryEnabled bool) bool {
...
// is set.
func isNullOutpointV2(tx *wire.MsgTx) bool {
...
// base.
func IsTreasuryBaseV2(tx *wire.MsgTx) bool {
