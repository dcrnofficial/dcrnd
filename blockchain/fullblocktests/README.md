...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/Decred-Next/dcrnd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/Decred-Next/dcrnd/blockchain/fullblocktests
```
