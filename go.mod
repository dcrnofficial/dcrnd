...
require (
	github.com/Decred-Next/dcrnd/addrmgr/v8 v8.0.8
	...
	github.com/Decred-Next/dcrnd/connmgr/v8 v8.0.8
	github.com/Decred-Next/dcrnd/crypto/ripemd160/v8 v8.0.8
	github.com/Decred-Next/dcrnd/database/v8 v8.0.8
	github.com/Decred-Next/dcrnd/dcrec/secp256k1/version2/v8 v8.0.8
	github.com/Decred-Next/dcrnd/dcrec/v8 v8.0.8
	github.com/Decred-Next/dcrnd/dcrjson/version3/v8 v8.0.8
	github.com/Decred-Next/dcrnd/dcrutil/version2/v8 v8.0.8
	github.com/Decred-Next/dcrnd/fees/v8 v8.0.8
	github.com/Decred-Next/dcrnd/gcs/version2/v8 v8.0.8
	github.com/Decred-Next/dcrnd/hdkeychain/version2/v8 v8.0.8
	github.com/Decred-Next/dcrnd/lru/v8 v8.0.8
	github.com/Decred-Next/dcrnd/mempool/v8 v8.0.8
	github.com/Decred-Next/dcrnd/mining/v8 v8.0.8
	github.com/Decred-Next/dcrnd/peer/v8 v8.0.8
