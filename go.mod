...
require (
	...
	github.com/Decred-Next/dcrnd/database/v8 v8.0.9
	...
	github.com/Decred-Next/dcrnd/fees/v8 v8.0.9
	github.com/Decred-Next/dcrnd/gcs/version2/v8 v8.0.9
	github.com/Decred-Next/dcrnd/hdkeychain/version2/v8 v8.0.9
	github.com/Decred-Next/dcrnd/lru/v8 v8.0.9
	github.com/Decred-Next/dcrnd/mempool/v8 v8.0.9
	github.com/Decred-Next/dcrnd/mining/v8 v8.0.9
	github.com/Decred-Next/dcrnd/peer/v8 v8.0.9
